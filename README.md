...
After several tryout, finally I changed the values to `N=10` and `dt=0.2` .
...
When dealing with the latency,I chose `dt=0.2` .And, I alsoincorporated the latency into the model.
